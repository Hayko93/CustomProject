function doLogin() {
    ...
    if (isEmpty(emailInput.val())) {
        ...
        emailInput.prev('p').removeAttr('hidden');
        isOk = false;
    }
...
function doRegister() {
    ...
    if (isEmpty(countryInput.val())){
        countryInput.addClass('danger-placeholder');
        countryInput.attr('placeholder', 'Email is required!');
        isOk = false;
    }
...
function validateEmail(email) {
    ...
    return eValid.test(String(email).toLowerCase());
}
